...
# open("archivo", "r") → para leer.
# open("archivo", "w") → para escribir (sobrescribe).
# with → asegura que el archivo se cierre automáticamente.
# Manejo de excepciones con try/except FileNotFoundError para evitar errores si el archivo no existe.
...
def cargar_agenda():
    try:
        ...
        print("No existe archivo de agenda. Se creará uno nuevo.")
...
AGENDA_FILE = "agenda.txt"  # aquí faltaria ahora modificar para poder elegir el archivo de agenda que queramos
agenda = {}                 # definimos el diccionario
cargar_agenda()             # cargamos los datos de la agenda en el diccionario, para poder trabajar con él.
...
while True:
    ...
    if opcion == "1":
        ...
        guardar_agenda()                        # GUARDAMOS LA AGENDA EN UN ARCHIVO agenda.txt  -- FALTA PODER ELEGIR EL ARCHIVO DE GUARDADO
        break 
